...
void tick()
{
  ...
  int state = digitalRead(BUILTIN_LED);  // Obtener estado actual
  digitalWrite(BUILTIN_LED, !state);     // cambiar al estado opuesto
}

//Entrar en modo de configuracion
void configModeCallback (WiFiManager *myWiFiManager) {
  Serial.println("Entre a modo de configuracion");
